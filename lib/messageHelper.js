...
const sendMessages = (req, res) => {
  ...
  // To user
  if(userPhone){
    sendSMS(userPhone, 'Auto World -Thank yo for your interest!\n bla~bla~');
  }

  //To admin / Need ADMIN_PHONE in .env file
  if(process.env.ADMIN_PHONE){
    sendSMS(process.env.ADMIN_PHONE, emailTitle+'\n'+emailMessage);
  }

  //To user
  sendEmail(res, userEmail, emailTitle, 'Auto World -Thank yo for your interest!\n bla~bla~');
